    ...
    <section className="bg-secondary px-5 py-14 sm:px-8 sm:py-20 lg:py-28">
      <div className="mx-auto max-w-[1200px]">
        <Reveal stagger className="text-center">
          <RevealItem>
            <SectionLabel>Why Aurelia</SectionLabel>
          </RevealItem>
          <RevealItem
            as="div"
            blur
        ...
        <Reveal
          stagger
          className="mt-6 grid grid-cols-1 gap-4 sm:mt-14 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3"
        >
          {trustCards.map((card) => {
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="text-[0.85rem] font-medium leading-tight text-foreground sm:font-serif sm:text-xl">
                    {card.title}
                  </h3>
                  <p className="mt-1 text-[0.85rem] leading-snug text-muted-foreground sm:mt-1.5 sm:text-base sm:leading-relaxed">
                    {card.body}
                  </p>
                </div>
              </RevealItem>
